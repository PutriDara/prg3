...
<form method="POST">
	<table class="table table-bordered" border="1">
			<input type="hidden" name="id_barang" value="<?php echo $tampil_data['id_barang'];?>">
			<tr>
					<td>Id Barang</td>
					<td><input type="text" name="id_barang" class="form-control" value="<?php echo $tampil_data['id_barang'];?>"></td>
			</tr>	
			<tr>
			    <td>Id Kategori</td>
					<td><input type="text" name="id_kategori" class="form-control" value="<?php echo $tampil_data['id_kategori'];?>"></td>
			</tr>	
			<tr>
			    <td>Nama</td>
